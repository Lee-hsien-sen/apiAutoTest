 ...
 * @Copyright:
 */
public class joinSuccess extends QZ implements API {
	
	public String parameter; //参数集合
	public String sdkRoomId; //企业id
	public String sdkAccountId; //昵称
	...
	public HashMap<String, Object> handleInput(HashMap<String, Object> data) {
		...
		sdkRoomId = MapUtil.getParameter_get(parameter,"sdkRoomId").trim();
		sdkAccountId = MapUtil.getParameter_get(parameter,"sdkAccountId").trim();
		if(!sdkRoomId.equals("") && sdkRoomId.equals("code")){
			sdkRoomId = sdk_RoomId; 
			parameter = parameter.replace("sdkRoomId=code", "sdkRoomId="+ sdkRoomId );
		}
		if(!sdkAccountId.equals("") && sdkAccountId.equals("code")){
			sdkAccountId = sdk_AccountId; 
			parameter = parameter.replace("sdkAccountId=code", "sdkAccountId="+ sdkAccountId );
		}
