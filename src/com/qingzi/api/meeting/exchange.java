...
public class exchange extends QZ implements API {
...
//            System.out.println("operated::" + JSONObject.fromObject(pubMap));
    ...
    public Response SendRequest(HashMap<String, String> headers, HashMap<String, Object> data, String Url,
        ...
        header.put("Cst-Token", s_UserToken);
        myRequest.setHeaders(header);
        myRequest.setRequest(Request);
        myRequest.setParameter(parameter);
        Log.logInfo("==header:"+ header+ "==Request:"+parameter);
...
//				*//接口返回token
                ...
                try {
                    authKey = EccUtils.doExchange(userAccountId, dev, serverPub,clientPri);
