...
public class auth extends QZ implements API {
	...
	public HashMap<String, Object> handleInput(HashMap<String, Object> data) {
		...
		if(!os_version.equals("") && os_version.equals("code")){
			os_version = "v1.0.4";
			parameter = parameter.replace("\"os_version\":code", "\"os_version\":\""+ os_version + "\"");
		}
		if(!uid.equals("") && uid.equals("code")){
			uid = "654321";
			parameter = parameter.replace("\"uid\":code", "\"uid\":\""+ uid + "\"");
		}
		if(!app_version.equals("") && app_version.equals("code")){
			app_version = "v1.0.0";
			parameter = parameter.replace("\"app_version\":code", "\"app_version\":\""+ app_version + "\"");
		}
